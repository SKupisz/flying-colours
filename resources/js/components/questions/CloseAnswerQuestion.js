...
export default class CloseAnswerQuestion extends React.Component{
    render(){
        return <Grid item xs={12}>
            ...
            {((this.props.currentQuestionData["type"] === "csa" && this.props.currentQuestionData["correctAnswerInd"] !== -1) ||
            (this.props.currentQuestionData["type"] === "cma" && this.props.currentQuestionData["correctAnswerInd"].length > 0)) && this.props.currentQuestionType !== -1 && this.props.currentQuestionData["questionName"].length > 0? <Grid item xs={12}>
